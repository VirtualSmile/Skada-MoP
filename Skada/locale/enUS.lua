...
L["The background texture used by all bars."] = true
L["Bar spacing"] = true
...
L["Sets the rate in-which Skada scans for new information."] = "Sets the rate in-which Skada scans for new information."
...
L["Class color value text"] = "Class color value text"
L["When possible, value text will be colored according to player class."] = "When possible, value text will be colored according to player class."
L["Smooth bars"] = "Smooth bars"
L["Attempt to smoothen the bar display."] = "Attempt to smoothen the bar display."
