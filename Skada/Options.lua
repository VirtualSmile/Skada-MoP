			...
			generaloptions = {
				...
				args = {
					...
					updaterate = {
						type="range",
						name=L["Update rate"],
						desc=L["Sets the rate in-which Skada scans for new information."],
						min=0.05,
						max=1,
						step=0.05,
						get=function() return Skada.db.profile.updaterate end,
						set=function(self, val) Skada.db.profile.updaterate = val end,
						order=13,
					},
